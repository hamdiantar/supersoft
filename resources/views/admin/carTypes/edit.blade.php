...
@section('title')
<title>{{ __('Super Car') }} - {{ __('Edit Car Type') }} </title>
@endsection
@section('content')
    <div class="row small-spacing">
        <nav>
            ...
            <li class="breadcrumb-item"><a href="{{route('admin:home')}}"> {{__('Dashboard')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin:companies.index')}}"> {{__('Cars Types')}}</a></li>
                <li class="breadcrumb-item active"> {{__('Edit Car Type')}}</li>
            </ol>
        </nav>
        <div class="col-xs-12">
        <div class=" card box-content-wg-new bordered-all primary">
            ...
            <div class="box-content">
                <form method="post" action="{{route('admin:carTypes.update', ['id' => $carType->id])}}" class="form">
                    @csrf
                    @method('put')
                    ...
                    <div class="col-md-12">
                        ...
                        <span class="input-group-addon"><i class="fa fa-file-o"></i></span>
                            <input type="text" name="type_ar" class="form-control" value="{{$carType->type_ar}}" id="inputNameAR" placeholder="{{__('Type In arabic')}}">
                        </div>
                        ...
                        <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-file-o"></i></span>
                            <input type="text" name="type_en" class="form-control" id="inputNameEN" value="{{$carType->type_en}}" placeholder="{{__('Type In English')}}">
                        </div>
