...
@section('content')
        ...
        <div class="col-xs-12">
            <div class=" card box-content-wg-new bordered-all primary">
                ...
                <div class="box-content">
                    <form id="quotation_forms" action="{{route('admin:quotations.store')}}" class="form" method="post">
                        @csrf
                        @method('post')

                        @include('admin.quotations.info_section')
                        ...
                        <div class="form-group has-feedback col-md-3" id="customer_data" style="padding-bottom: 19px;">
                            ...
                            <select name="customer_id" class="form-control js-example-basic-single" id="customer_value">
                                ...
                                @foreach($customers as $customer)
                                    <option
                                        value="{{$customer->id}}">{{$customer->name .'-'. $customer->phone1}}</option>
                                @endforeach
                            </select>
                        ...
                        @include('admin.quotations.parts.spareParts')
                        @include('admin.quotations.services.services')
                        @include('admin.quotations.packages.packages')
                        @include('admin.quotations.winch.winch_details')
    ...
    @include('admin.quotations.taxes.index')
@endsection
...
@section('js-validation')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\Quotation\CreateQuotationRequest', '.form'); !!}
