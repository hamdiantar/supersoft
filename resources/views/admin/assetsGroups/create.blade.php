        ...
        <div class="row small-spacing">
            <nav>
                ...
                <li class="breadcrumb-item"><a href="{{route('admin:home')}}"> {{__('Dashboard')}}</a></li>
                    <li class="breadcrumb-item"><a href="{{route('admin:assetsGroup.index')}}"> {{__('assetsGroup')}}</a></li>
                <li class="breadcrumb-item"> {{__('Create Asset Group')}}</li>
                </ol>
            </nav>
            <div class="col-xs-12">
                <div class=" card box-content-wg-new bordered-all primary">
                    <h1 class="box-title bg-info" style="text-align: initial"><i class="fa fa-file"></i>{{__('Create Asset Group')}}
