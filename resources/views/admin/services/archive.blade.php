...
@section('title')
    <title>{{ __('Super Car') }} - {{ __('Services Archive') }} </title>
@endsection
@section('content')
    <div class="row small-spacing">
        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Services Archive')}}</li>
            </ol>
        </nav>
                                ...
                                <!-- <td>{!! optional($service->branch)->name !!}</td> -->
                                    ...
                                    <td>
                                        ...
                                        @component('admin.buttons._restore_delete',[
                                                     'id'=>$service->id,
                                                     'route' => 'admin:services.restore_delete',
                                                     'tooltip' => __('Force Delete '.$service['name']),
                                                      ])
                                        @endcomponent
                                    </td>
                                    <td>
