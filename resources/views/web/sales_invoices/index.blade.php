    ...
    <div class="row small-spacing">
        ...
        <div class="col-xs-12">
                <div class="box-content card bordered-all js__card top-search">
                    ...
                    <div class="card-content js__card_content" style="padding:20px">
                        <form action="{{route('web:sales.invoices.index')}}" method="get" id="filtration-form">
                            ...
                            <button type="submit" class="btn sr4-wg-btn   waves-effect waves-light hvr-rectangle-out"><i
                                    class=" fa fa-search "></i> {{__('Search')}} </button>
                            <a href="{{route('web:sales.invoices.index')}}"
        ...
        <div class="col-xs-12">
            <div class="box-content card bordered-all js__card">
                <h4 class="box-title with-control">
                <span> <i class="fa fa-file-text-o"></i>  {{__('Sales Invoices')}}</span>
                 </h4>
                ...
                <div class="card-content js__card_content" style="">
                    ...
                    <div class="table-responsive">
                        @php
                            $view_path = 'web.sales_invoices.options-datatable';
                        @endphp
                                ...
                                <tr>
                                    ...
                                    <td class="text-center column-invoice-type">
                                        @if ($invoice->type === "cash")
                                            <span class="label label-primary wg-label">{{__($invoice->type)}}</span>
                                        @else
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="text-align:center">
                    ...
                    <button type="button" class="btn btn-primary waves-effect waves-light" onclick="printDownPayment()" id="print_sales_invoice">
...
@section('js')
    ...
    <script type="application/javascript">
        ...
        function getPrintData(id) {
            $.ajax({
                url: "{{ route('web:sales.invoices.show') }}?invoiceID=" + id,
                method: 'GET',
