...
@section('title')
    <title>{{ __('Super Car') }} - {{ __('Create Shift') }} </title>
@endsection
@section('content')
        ...
        <div class="col-xs-12">
            <div class=" card box-content-wg-new bordered-all primary">
                ...
                <div class="box-content">
                    <form method="post" action="{{route('admin:shifts.store')}}" class="form">
                        @csrf
                        @method('post')
                        @if(authIsSuperAdmin())
                        ...
                        <div class="form-group has-feedback col-sm-2">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><li class="fa fa-clock-o"></li></span>
                                <input type="time" name="end_from" class="form-control"
                                       value="{{now()->format('h:i')}}"></div>
