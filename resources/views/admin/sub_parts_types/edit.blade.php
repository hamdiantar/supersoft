        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item"><a
                        href="{{route('admin:sub.spare.parts.index')}}"> {{__('Sub Spare parts')}}</a>
                </li>
                <li class="breadcrumb-item active"> {{__('Edit Sub Spare Part')}}</li>
            </ol>
        </nav>
        ...
        <div class="col-xs-12">
            <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial"><i class="fa fa-check-square-o"></i>
                    {{__('Edit Sub Spare Part')}}
                    <span class="controls hidden-sm hidden-xs pull-left">
                  <button class="control text-white"
                          style="background:none;border:none;font-size:12px">{{__('Save')}}
                      <img class="img-fluid" style="width:50px;height:50px;margin-top:-20px;margin-bottom:-13px" src="{{asset('assets/images/f1.png')}}"></button>
                ...
                <div class="box-content">
                    <form method="post" action="{{route('admin:sub-spare-parts.update', ['id' => $sparePart->id])}}"
...
@section('js-validation')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\SubSpareParts\UpdateRequest', '.form'); !!}
