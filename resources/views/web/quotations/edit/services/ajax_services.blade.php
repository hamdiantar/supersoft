                    ...
                    <div class="widget-content widget-content-area h-100 br-4 p-0">
                        <div class="top-exchange-rate">
                            ...
                            <div class="top-exchange-rate-body">
                                <div class="">
                                    <ul class="nav nav-pills nav-stacked right-list-wg anyClass wg-img-bg list-inline">
                    ...
                    <div class="widget-content widget-content-area h-100 br-4 p-0">
                        <div class="top-exchange-rate">
                            ...
                            <div class="top-exchange-rate-title">
                                ...
                                <input type="text" id="searchInServicesData" onkeyup="searchInServices()"
                                       placeholder="{{__('Search')}}"
                                       class="form-control"
                                >

                                <ul class="nav nav-pills nav-stacked right-list-wg anyClass d-flex-wg-left wg-list"
                                    id="services_data"
                                >
                                    ...
                                    @foreach($services as $service)
                                        <li class="nav-item bg-blue text-white pakage-item hvr-shrink remove_ajax_services">
                                            ...
                                            <a style="font-size: 12px" class="nav-link active"
            ...
            <div class="anyClass-wg table-responsive">
                <table id="invoiceItemsDetails" class="table table-bordered" style="width:100%">
                    ...
                    @foreach($quotationServiceType->items as $index=>$service_item)
                        ...
                        @include('admin.quotations.edit.services.service_details')

                        <input type="hidden" name="part_id" value="{{$service->id}}" id="service-{{$index+1}}">
                    @endforeach
                    </tbody>
                ...
                <input type="hidden" name="services_items_count" id="services_items_count"
                       value="{{$quotationServiceType->items->count()}}">
            </div>
        </div>
