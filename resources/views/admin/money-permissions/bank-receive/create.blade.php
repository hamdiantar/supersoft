...
@section('title')
    <title>{{ __('Super Car') }} - {{ __('words.bank-receives-create') }} </title>
@endsection
    ...
    <div class="row small-spacing">
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('words.bank-receives-create')}}</li>
            </ol>
        </nav>
        <div class="col-xs-12">
            <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial">
                    <i class="fa fa-money"></i> {{ __('words.bank-receives-create') }}
                ...
                <div class="box-content">
                    <form method="post" action="{{route('admin:bank-receives.store')}}" class="form">
                        @csrf
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="bank_exchange_permission_id" id="exchange-permissions"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="bank-from" readonly class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">{{ __('words.to') }}</label>
                                        <input type="text" id="bank-to" readonly class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
...
@section('js-validation')
    {!! JsValidator::formRequest('App\Http\Requests\MoneyPermissions\BankReceiveRequest', '.form'); !!}
    ...
    <script type="application/javascript">
        $(document).on('change' ,'#exchange-permissions' ,function () {
            ...
            if (!exchange.amount) {
                ...
                $('#bank-from').val(exchange.from_locker ? exchange.from_locker.trans_name : exchange.from_bank.trans_name)
