    ...
    <div style="border: #AAA solid 1px;border-top:20px solid grey;border-radius:15px 15px 5px 5px;min-height:170px">
        ...
        <div class="num-w">
            <div style="border: #AAA solid 1px;border-radius:5px;padding:10px;margin-top:10px">
                <h3 class="text-center" style="font-weight:bold ">{{ __('words.locker-exchange') }}</h3>
                    ...
                    <div class="col-xs-6">
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <td>{{ optional($exchange->fromLocker)->name }}</td>
                            </tbody>
                        </table>
                    </div>
                    <div class="col-xs-6">
...
<div>
    <div style="margin-top:13px">
        @if($exchange->status == 'pending')
            <a href="{{ route('admin:locker-exchanges.approve' ,['id' => $exchange->id]) }}" class="btn btn-success">
                <i class="fa fa-check"></i> {{ __('words.approve-permission') }}
            </a>
            <a href="{{ route('admin:locker-exchanges.reject' ,['id' => $exchange->id]) }}" class="btn btn-warning">
