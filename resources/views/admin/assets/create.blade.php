...
<div class="row small-spacing">
    ...
    <div class="col-xs-12">
        <div class=" card box-content-wg-new bordered-all primary">
            <h4 class="box-title with-control" style="text-align: initial"><i class="fa fa-cubes"></i>  {{__('words.create-asset')}}
                                    ...
                                    <select class="form-control select2" id="asset_group_id" name="asset_group_id">
                                        ...
                                        @foreach($assetsGroups as $assetGroup)
                                            <option {{ old('assetsGroups_id') == $assetGroup->id ? 'selected' : '' }}
                                                value="{{ $assetGroup->id }}" rate="{{ $assetGroup->annual_consumtion_rate }}"> {{ $assetGroup->name_ar }} </option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="col-md-4">
                                    ...
                                    <ul class="list-inline">
                                            <li>
                                                <div class="radio info">
                                                    <input type="radio" id="radio_status_1" name="asset_status" value="1" checked >
                                            ...
                                            <li>
                                                <div class="radio info">
                                                    <input id="radio_status_2" type="radio" name="asset_status" value="2"  >
                                            ...
                                            <li>
                                                <div class="radio info">
                                                    <input type="radio" id="radio_status_3" name="asset_status" value="3"  >
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" disabled name="annual_consumtion_rate" id="annual_consumtion_rate"/>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="asset_details" placeholder="{{ __('Notes') }}">{{ old('notes') }}</textarea>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control " type="text" name="purchase_cost"/>
                                </div>
