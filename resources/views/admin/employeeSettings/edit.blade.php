...
@section('title')
    <title>{{ __('Super Car') }} - {{ __('Edit Employees Setting') }} </title>
@endsection
...
@section('content')
    ...
    <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Edit Employees Setting')}}</li>
            </ol>
        </nav>

        <div class="col-xs-12">
        <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial"><i class="fa fa-user"></i>  {{__('Edit Employees Setting')}}
                ...
                <button class="control text-white" style="background:none;border:none;font-size:12px">{{__('Save')}}<img class="img-fluid" style="width:50px;height:50px;margin-top:-20px;margin-bottom:-13px" src="{{asset('assets/images/f1.png')}}"></button>
                    ...
                    <form method="post" action="{{route('admin:employee_settings.update', ['id' => $employeeSetting->id])}}" class="form">
                        @csrf
                        @method('put')
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                                            <input class="form-control" name="name_ar"  value="{{$employeeSetting->name_ar}}" placeholder="{{__('Employee Category Arabic Name')}}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                                            <input class="form-control" name="name_en" value="{{$employeeSetting->name_en}}" placeholder="{{__('Employee Category English Name')}}">
                                ...
                                <div class="col-md-12">
                                            ...
                                            <ul class="list-inline">
                                                <li>
                                                    <div class="radio info">
                                                        <input type="radio" name="type_account" value="work_card"
                                                            {{$employeeSetting->type_account === __('work_card') ? 'checked' : ''}}
                                                            id="radio-10">
                                                ...
                                                <li>
                                                    <div class="radio info">
                                                        <input type="radio" name="type_account" value="days"
                                                            {{$employeeSetting->type_account === __('days') ? 'checked' : ''}}
                                                            id="radio-11">
                                                ...
                                                <li>
                                                    <div class="radio pink">
                                                        <input type="radio" name="type_account" value="month"
                                                            {{$employeeSetting->type_account === __('month') ? 'checked' : ''}}
                                                            id="radio-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="card_work_percent"
                                                    value="{{ $employeeSetting->card_work_percent }}"
                                                    placeholder="{{__('Percent Card Value')}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                                            <input type="text" class="form-control time" name="amount_account" value="{{$employeeSetting->amount_account}}" placeholder="{{__('Account Amount')}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                                            <input type="text" class="form-control" name="max_advance" value="{{$employeeSetting->max_advance}}" placeholder="{{__('Max Advance')}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="daily_working_hours" value="{{$employeeSetting->daily_working_hours}}" placeholder="{{__('Daily Work Hours')}}">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group has-feedback col-sm-12">
                                    ...
                                    <div class="switch primary" style="margin-top: 15px">
                                        ...
                                        <input type="checkbox" id="switch-1" name="status" value="1" {{$employeeSetting->status === 1 ? 'checked' : ''}}>
                            ...
                            <div class="col-md-2">
                                <div class="form-group has-feedback col-sm-12">
                                    ...
                                    <div class="switch primary" style="margin-top: 15px">
                                        <input type="checkbox" id="switch-service-status" name="service_status"
                                                {{$employeeSetting->service_status == 1 ? 'checked':''}}
                                        >
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control time" name="time_attend" value="{{$employeeSetting->time_attend}}" placeholder="{{__('Attendance Time')}}">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label> {{__('Leaving Time')}}  <i class="req-star" style="color: red">*</i></label>
                                        <input type="time" class="form-control time" name="time_leave" value="{{$employeeSetting->time_leave}}" placeholder="{{__('Leaving Time')}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="annual_vocation_days"
                                                   value="{{$employeeSetting->annual_vocation_days}}"
                                                   placeholder="{{__('Yearly Vacations Days')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <ul class="list-inline">
                                            <li>
                                                <div class="radio info">
                                                    <input type="radio" name="type_absence" value="discount_day"
                                                           {{$employeeSetting->type_absence === 'discount_day' ? 'checked' : ''}}
                                                           id="radio-91"><label for="radio-91">{{__('Deducted Day')}}</label></div>
                                            </li>
                                            <li>
                                                <div class="radio pink">
                                                    <input type="radio" name="type_absence" value="fixed_salary"
                                                           {{$employeeSetting->type_absence === 'fixed_salary' ? 'checked' : ''}}
                                                           id="radio-92"><label for="radio-92">{{__('Static Amount')}}</label></div>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="type_absence_equal" value="{{$employeeSetting->type_absence_equal}}"
                                               placeholder="{{__('Absence Day Equal To')}}">
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label> {{__('Delay Hour')}} </label>
                                        <ul class="list-inline">
                                            <li>
                                                <div class="radio info">
                                                    <input type="radio" name="hourly_delay" value="hourly_delay"
                                                           {{$employeeSetting->hourly_delay === 'hourly_delay' ? 'checked' : ''}}
                                                           id="radio-93"><label for="radio-93">{{__('Delay Hour')}}</label></div>
                                            </li>
                                            <li>
                                                <div class="radio pink">
                                                    <input type="radio" name="hourly_delay" value="fixed_salary"
                                                           {{$employeeSetting->hourly_delay === 'fixed_salary' ? 'checked' : ''}}
                                                           id="radio-94"><label for="radio-94">{{__('Static Amount')}}</label></div>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="hourly_delay_equal" value="{{$employeeSetting->hourly_delay_equal}}" placeholder="{{__('Delay Hour Equal To')}}">
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label> {{__('Additional Hour')}} </label>
                                        <ul class="list-inline">
                                            <li>
                                                <div class="radio info">
                                                    <input type="radio" name="hourly_extra" value="hourly_extra"
                                                           {{$employeeSetting->hourly_extra === 'hourly_extra' ? 'checked' : ''}}
                                                           id="radio-95"><label for="radio-95">{{__('Additional Hour')}}</label></div>
                                            </li>
                                            <li>
                                                <div class="radio pink">
                                                    <input type="radio" name="hourly_extra" value="fixed_salary"
                                                           {{$employeeSetting->hourly_extra === 'fixed_salary' ? 'checked' : ''}}
                                                           id="radio-96"><label for="radio-96">{{__('Static Amount')}}</label></div>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="hourly_extra_equal" value="{{$employeeSetting->hourly_extra_equal}}" placeholder="{{__('Additional Hour Equal To')}}">
                                    </div>
                                </div>
                            </div>
