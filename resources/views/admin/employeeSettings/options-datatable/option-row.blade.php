...
<div class="col-md-8 col-sm-8 col-xs-12 buttons-wg wg-style text-قهلاف-wg">
...
<div class="col-md-4 col-sm-4 col-xs-12 text-مثبف-wg" style="padding-right: 0;margin-top:10px">
     ...
     <span class="input-group-btn">
       ...
       <input id="free-search" type="text" class="search-btn-wg"
        placeholder="{{ __('accounting-module.search') }} : {!! __('Employee Category Name') !!},{!! __('Created At') !!},{!! __('Updated At') !!}"
