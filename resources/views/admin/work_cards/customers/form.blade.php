    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class=" card box-content-wg-new bordered-all primary">
                ...
                <form id="add_customer_form_e">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedbac">
                                        <label for="inputSymbolAR" class="control-label">{{__('Select Customer Category')}}</label>
                                        <select name="customer_category_id"
                                                class="form-control js-example-basic-single"
                                                id="customer_group_options">
                                            <option value="" class="removeGroupsToNewData">
                                                {{__('Select Customer Group')}}
                                            </option>
                                            @foreach( $customerGroups as $customerGroup)
                                                <option value="{{$customerGroup->id}}" class="removeGroupsToNewData">
                                                    {{$customerGroup->name}}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            {{--                    <div class="col-md-4">--}}
                            {{--                        <div class="form-group has-feedback">--}}
                            {{--                            <label for="balance_to" class="control-label">{{__('Balance To')}}</label>--}}
                            {{--                            <div class="input-group">--}}
                            {{--                                <span class="input-group-addon"><li class="fa fa-home"></li></span>--}}
                            {{--                                <input type="text" name="balance_to" class="form-control" id="balance_to"--}}
                            {{--                                       placeholder="{{__('Balance To')}}">--}}
                            {{--                            </div>--}}
                            {{--                            {{input_error($errors,'balance_to')}}--}}
                            {{--                        </div>--}}
                            {{--                    </div>--}}

                            {{--                    <div class="col-md-4">--}}
                            {{--                        <div class="form-group has-feedback">--}}
                            {{--                            <label for="balance_to" class="control-label">{{__('Balance For')}}</label>--}}
                            {{--                            <div class="input-group">--}}
                            {{--                                <span class="input-group-addon"><li class="fa fa-home"></li></span>--}}
                            {{--                                <input type="text" name="balance_for" class="form-control" id="balance_to"--}}
                            {{--                                       placeholder="{{__('Balance For')}}">--}}
                            {{--                            </div>--}}
                            {{--                            {{input_error($errors,'balance_for')}}--}}
                            {{--                        </div>--}}
                            {{--                    </div>--}}
                        ...
                        <div class="modal-footer">
                            <div class="form-group col-sm-12">
                                <button type="button" class="btn hvr-rectangle-in saveAdd-wg-btn  "
                                        onclick="addCustomerQuotations()">
                                    <i class="ico ico-left fa fa-save"></i>
                                    {{__('Save')}}
                                </button>
                                <button id="reset" type="button"
                                        class="btn hvr-rectangle-in resetAdd-wg-btn  "><i
                                            class="ico ico-left fa fa-trash"></i>{{__('Reset')}}</button>
                                <button type="button" class="btn hvr-rectangle-in closeAdd-wg-btn  "
                ...
                @include('admin.quotations.cars.add_car')
            </div>
        </div>
    </div>
</div>
