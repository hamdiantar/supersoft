...
<div class="container">
    ...
    <div class="form_new_contact">
        ...
        @if(isset($customer) && $customer->contacts )
                ...
                <div class="row " id="contact_{{$contact->id}}">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" required id="name_{{$contact->id}}"
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" required id="phone_1_{{$contact->id}}"
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" id="phone_2_{{$contact->id}}"
                                   name="contactsUpdate[{{$contact->id}}][phone_2]" value="{{$contact->phone_2}}"  required class="form-control">
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <textarea id="address_{{$contact->id}}"
                                      name="contactsUpdate[{{$contact->id}}][address]" class="form-control" style=" height: 45px;">{{$contact->address}}</textarea>
...
{{--                            </button>--}}
        ...
        @endif
            @if($errors->has('contacts.*.name') || $errors->has('contacts.*.phone_1'))
                @include('web.customers.contacts.ajax_form_new_contact', ['index' =>  $index ?? 456456])
            @endif
