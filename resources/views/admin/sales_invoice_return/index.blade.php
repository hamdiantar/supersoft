...
@section('content')
    <div class="row small-spacing">
        ...
        <div class="col-xs-12">
            <div class="box-content card bordered-all js__card top-search">
                ...
                <div class="card-content js__card_content" style="padding:20px">
                    <form action="{{route('admin:sales.invoices.return.index')}}" method="get" id="filtration-form">
                        ...
                        @if(authIsSuperAdmin())
                            ...
                            <li class="form-group col-md-3">
                                <label> {{ __('Sales Invoice Number') }} </label>
                                <select name="sales_invoice_number" class="form-control js-example-basic-single">
                                    <option value="">{{__('Select Sales Invoice Number')}}</option>
                                    @foreach($salesInvoicesNumber as $invoiceNumber)
                                        <option value="{{$invoiceNumber->id}}">{{$invoiceNumber->inv_number}}</option>
                                    @endforeach
                                </select>
                            </li>
                            ...
                            <li class="form-group col-md-3">
                                ...
                                <input type="date" name="date_from" class="form-control" placeholder="{{__('Select Date')}}">
                            </li>

                            <li class="form-group col-md-3">
                                <label> {{ __('Date To') }} </label>
                                <input type="date" name="date_to" class="form-control" placeholder="{{__('Select Date')}}">
                            </li>
        ...
        <div class="box-content card bordered-all js__card">
                ...
                <i class="fa fa-file-text-o"></i>  {{__('Sales Invoices Returns')}}
                 </h4>
                 ...
                 <div class="card-content js__card_content" style="">
                    <ul class="list-inline pull-left top-margin-wg">
                        <li class="list-inline-item">
                           ...
                           'route' => 'admin:sales.invoices.return.create',
                           'new' => '',
                          ])
                        </li>
                            ...
                            <li class="list-inline-item">
                                ...
                                'route' => 'admin:sales.invoices.return.deleteSelected',
                                 ])
                                @endcomponent
                            </li>
                    ...
                    <div class="table-responsive">
                        @php
                            $view_path = 'admin.sales_invoice_return.options-datatable';
                        @endphp
                        ...
                        <table id="purchaseInvoices" class="table table-bordered" style="width:100%;margin-top:15px">
                            ...
                            @foreach($invoices as $index=>$invoice)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin:sales.invoices.return.expense.receipts',$invoice->id)}}"
...
@section('js')
    <script type="application/javascript">
        ...
        function getPrintData(id) {
            $.ajax({
                url: "{{ route('admin:sales.invoices.return.show') }}?invoiceID=" + id,
                method: 'GET',
