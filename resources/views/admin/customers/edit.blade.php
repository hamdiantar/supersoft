        ...
        <div class="col-xs-12">
            <div class=" card box-content-wg-new bordered-all primary">
                <h1 class="box-title bg-info" style="text-align: initial"><i
                        class="fa fa-user"></i>{{__('Edit customers and cars')}}
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <select name="branch_id" class="form-control js-example-basic-single"
                                                ...
                                                @foreach(\App\Models\Branch::all() as $branch)
                                                    <option
                                                        value="{{$branch->id}}" {{$customer->branch_id == $branch->id ? 'selected' : ''}}>{{$branch->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="customer_category_id" class="form-control js-example-basic-single"
                                            ...
                                            @foreach($customerCategories as $category)
                                                <option
                                                    value="{{$category->id}}" {{$customer->customer_category_id == $category->id ? 'selected' : ''}}>{{$category->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="country_id" class="form-control js-example-basic-single"
                                            ...
                                            @foreach(\App\Models\Country::all() as $country)
                                                <option
                                                    value="{{$country->id}}" {{$customer->country_id == $country->id ? 'selected' : ''}}>{{$country->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="city_id" class="form-control js-example-basic-single" id="city">
                                            @foreach(\App\Models\City::all() as $city)
                                                <option
                                                    value="{{$city->id}}" {{$customer->city_id == $city->id ? 'selected' : ''}}>{{$city->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                            ...
                                            <select name="area_id" class="form-control  js-example-basic-single select2"
                                                ...
                                                @foreach(\App\Models\Area::all() as $area)
                                                    <option value="{{$area->id}}"
                                                        {{$customer->area_id == $area->id ? 'selected' : ''}}>
                                                        {{$area->name}}
                                                    </option>
                                                @endforeach
                                            </select>
...
<div class="col-md-4">
    <label style="visibility: hidden;">{{__('Location')}}</label><br>
<a data-toggle="modal" data-target="#boostrapModal-2" title="Cars info"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                  <textarea name="notes" class="form-control" rows="4" cols="200">
                                      {{$customer->notes}}
                                  </textarea>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="switch primary">
                                        <input type="checkbox" id="switch-2"
                                               name="can_edit" {{$customer->can_edit == 1 ? 'checked' : ''}}>
...
@section('js-validation')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\CustomerCar\UpdateCustomerRequest', '.form'); !!}
        ...
        function destroyContact (contact_id) {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        type: 'post',
                        url: '{{route('admin:customers.contact.destroy')}}',
                        data: {
                            _token: CSRF_TOKEN,
        ...
        function updateContact (contact_id) {
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '{{route('admin:customers.contact.update')}}',
                        data: {
                            _token: CSRF_TOKEN,
                            contact_id:contact_id,
                            phone_1:phone_1,
