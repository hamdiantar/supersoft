...
class CreatePurchaseReceiptExecutionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_receipt_executions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('purchase_receipt_executions');
    }
}
