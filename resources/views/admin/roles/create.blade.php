...
@section('content')
    <div class="row small-spacing">
            ...
            <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial"><i class="ico fa fa-user"></i>
                    ...
                    <span class="controls hidden-sm hidden-xs pull-left">
                      ...
                      <img class="img-fluid" style="width:45px;height:45px;margin-top:-15px;margin-bottom:-13px"
        ...
        @section('js-validation')
            {!! JsValidator::formRequest('App\Http\Requests\Admin\Authorization\CreateRoleRequest', '.form'); !!}
