...
class BankReceiveRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'bank_exchange_permission_id' => 'required|exists:bank_exchange_permissions,id',
    ...
    function attributes() {
        return [
            'bank_exchange_permission_id' => __('words.bank-exchange-permission'),
