...
<td>
    <select name="purchase_invoice_id[]" class="js-example-basic-single" style="width: 100%" id="purchase-invoice-{{$index}}"
...
<td>
    <input type="number" class="form-control" value="{{$part->selling_price}}"
...
<td>
    <input type="number" class="form-control" value="0" name="item_discount[]"
           onkeyup="setServiceValues({{$index}})" onchange="setServiceValues({{$index}})"
           id="discount-{{$index}}">
</td>
...
<td><input type="number" class="form-control" readonly value="0"
