...
<div class="col-md-4 col-sm-4 col-xs-12 text-right-wg" style="padding-right: 0;margin-top:10px">
     ...
     <span class="input-group-btn">
       ...
       <input id="free-search" type="text" class="search-btn-wg"
        placeholder="{{ __('accounting-module.search') }} : {!! __('Date') !!} ,{!! __('Created At') !!} ,{!! __('Updated At') !!}"
