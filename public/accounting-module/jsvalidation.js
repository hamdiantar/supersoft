 ...
 * @version 1.3.6
 *
 * Date formatter utility upload_library that allows formatting date/time variables or Date objects using PHP DateTime format.
 * This upload_library is a standalone javascript upload_library and does not depend on other libraries or plugins like jQuery. The
 * upload_library also adds support for Universal Module Definition (UMD).
 *
