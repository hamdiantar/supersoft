...
@section('title')
<title>{{ __('Super Car') }} - {{__('Create Account')}} </title>
@endsection
...
@section('content')
    ...
    <nav>
            ...
            <li class="breadcrumb-item">  {{__('Create Account')}} </li>
            </ol>
        </nav>

        <div class="col-xs-12">
        <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial"><i class="fa fa-money"></i>  {{__('Create Account')}}
...
@section('js-validation')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\Accounts\CreateAccountsRequest', '.form'); !!}
