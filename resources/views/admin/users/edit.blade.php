...
@section('content')
    ...
    <nav>
            ...
            <li class="breadcrumb-item"><a href="{{route('admin:home')}}"> {{__('Dashboard')}}</a></li>
                ...
                <li class="breadcrumb-item active"> {{__('Edit User data')}}</li>
            </ol>
        </nav>
        <div class="col-xs-12">
...
@section('js-validation')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\Users\UpdateUserRequest', '.form'); !!}
