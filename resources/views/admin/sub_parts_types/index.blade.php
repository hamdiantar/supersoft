    ...
    <div class="row small-spacing">
        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Sub Spare parts')}}</li>
            </ol>
        </nav>

        @include('admin.sub_parts_types.search')

        <div class="col-xs-12">

            <div class="box-content card bordered-all js__card">
                <h4 class="box-title bg-secondary with-control">
                    <i class="fa fa-check-square-o"></i> {{__('Sub Spare parts')}}
                </h4>
                ...
                <div class="card-content js__card_content" style="">
                    <ul class="list-inline pull-left top-margin-wg">
                       ...
                       'route' => 'admin:sub.spare.parts.create',
                           'new' => '',
                          ])
                        </li>
                        ...
                        <li class="list-inline-item">
                          ...
                          'route' => 'admin:sub-spare-parts.deleteSelected',
                           ])
                            @endcomponent
                        </li>
                        ...
                        <table id="spare-parts" class="table table-bordered" style="width:100%">
                            ...
                            @foreach($sparePart as $index=>$part)
                                <tr>
                                    <td>{!! $index +1 !!}</td>
                                    <td>{!! $part->type !!}</td>
                                    <td><span class="label label-primary wg-label">{!! optional($part->parent)->type !!}</span></td>
            ...
            'image' => $part->image,
                                    ...
                                    <td>
                                        ...
                                        @component('admin.buttons._edit_button',[
                                                    'id'=>$part->id,
                                                    'route' => 'admin:sub.spare.parts.edit',
                                                     ])
                                        @endcomponent
