...
@section('title')
    <title>{{ __('Super Car') }} - {{ __('words.locker-exchanges-create') }} </title>
@endsection
    ...
    <div class="row small-spacing">
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('words.locker-exchanges-create')}}</li>
            </ol>
        </nav>
        <div class="col-xs-12">
            <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial">
                    <i class="fa fa-money"></i> {{ __('words.locker-exchanges-create') }}
                ...
                <div class="box-content">
                    <form method="post" action="{{ $form_action }}" class="form">
                        @csrf
                        <input type="hidden" name="destination_type" value="{{ isset($_GET['type']) && $_GET['type'] == 'bank' ? 'bank' : 'locker' }}"/>
                        <div class="row">
                            <div class="col-xs-12">
                                @if(authIsSuperAdmin())
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="from_locker_balance" value="0"/>
...
@section('js-validation')
    ...
    <script type="application/javascript">
        ...
        function check_lockers() {
            ...
            if (from_locker && to_locker && from_locker == to_locker && $('input[name="destination_type"]').val() == 'locker') {
