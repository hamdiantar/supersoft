...
@section('title')
<title>{{ __('Super Car') }} - {{__('Edit Locker Transfer')}} </title>
@endsection
...
@section('content')
    ...
    <nav>
            ...
            <li class="breadcrumb-item">  {{__('Edit Locker Transfer')}} </li>
            </ol>
        </nav>

        <div class="col-xs-12">
        <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial"><i class="fa fa-money"></i>  {{__('Edit Locker Transfer')}}
                ...
                <button class="control text-white" style="background:none;border:none;font-size:12px">{{__('Save')}}<img class="img-fluid" style="width:50px;height:50px;margin-top:-20px;margin-bottom:-13px" src="{{asset('assets/images/f1.png')}}"></button>
                    ...
                    <form method="post" action="{{route('admin:lockers-transfer.update',$lockers_transfer->id)}}" class="form"
