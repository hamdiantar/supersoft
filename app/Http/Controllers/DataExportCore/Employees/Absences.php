...
class Absences {
    ...
    function __construct($query_builder ,$visible_columns) {
        ...
        $this->columns = [
            'name' ,'type', 'days', 'date', 'created_at', 'updated_at'
        ];
        $this->header = [
    ...
    private function print() {
        ...
        return view('server-side-print' ,[
            ...
            'header' => $this->header,
            'title' => __('Employees Absences Printing'),
                    ...
                    foreach ($columns_keys as $key) {
                        switch ($key) {
                            case 'name':
                                ...
                                break;
                            case 'type':
                                $value = $record->absence_type == 'absence' ? __('Absence') : __('Vacation');
                                break;
                            case 'days':
    ...
    private function excel() {
        ...
        return Excel::download($export_object, 'Employees-Absences-'.date('YmdHis').'.csv');
    }
}