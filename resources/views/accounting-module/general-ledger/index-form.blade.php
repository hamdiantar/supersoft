...
<form id="filtration-form">
    ...
    <div class="col-md-3 form-group">
        ...
        <select class="form-control select2" name="acc_root_id"
        onchange="change_tree_options(event ,'{{ route('load-account-tree') }}' ,{{ isset($_GET['acc_tree_id']) ? $_GET['acc_tree_id'] : '' }})">
            {!! $accounts_root_tree !!}
        </select>
    </div>
    <div class="col-md-3 form-group">
    ...
    <div class="col-md-3 form-group">
        <label> {{ __('accounting-module.root-cost-center') }} </label>
        <select class="form-control select2" name="cost_root_id"
            onchange="change_cost_options(event ,'{{ route('load-cost-tree') }}' ,{{ isset($_GET['cost_root_id']) ? $_GET['cost_root_id'] : '' }})">
            {!! $cost_centers_root !!}
        </select>
    </div>
    <div class="col-md-3 form-group">
    ...
    <div class="form-group col-md-4">
        ...
        <a class="btn bc-wg-btn waves-effect waves-light hvr-rectangle-out" href="{{ route('accounting-general-ledger') }}">
