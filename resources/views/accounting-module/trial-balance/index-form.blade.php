...
<form id="filtration-form">
    ...
    <div class="col-md-3 form-group">
        <label> {{ __('accounting-module.report-by') }} </label>
        <select class="form-control select2" name="report_by">
            <option value="balance"
                {{ isset($_GET['report_by']) && $_GET['report_by'] == 'balance' ? 'selected' : '' }}>
                {{ __('accounting-module.report-by-balance') }}
            </option>
            <option value="transactions"
                {{ isset($_GET['report_by']) && $_GET['report_by'] == 'transactions' ? 'selected' : '' }}>
                {{ __('accounting-module.report-by-transactions') }}
            </option>
        </select>
    </div>
    ...
    <div class="form-group col-md-4">
        ...
        <a class="btn bc-wg-btn waves-effect waves-light hvr-rectangle-out" href="{{ route('trial-balance-index') }}">
