                ...
                <form>
                    <div class="row margin-bottom-0">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="main_type" class="form-control js-example-basic-single">
                                <option value="">{{__('Select Main Type')}}</option>
                                @foreach($mainSpareParts as $k=>$v)
                        ...
                        <div class="form-group col-md-4">
                            <label for="Type" class="control-label">{{__('Select Sub Type')}}</label>
                        ...
                        <div>
                            <div class="switch primary col-md-4" style="margin-top: 15px">
