...
@section('content')
    <div class="row small-spacing">
        ...
        <div class=" card box-content-wg-new bordered-all primary">
                ...
                <form method="post" action="{{route('admin:countries.update', ['id' => $country->id])}}" class="form">
                    @csrf
                    @method('put')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name_ar" class="form-control" value="{{$country->name_ar}}"
                                   id="inputNameAR" placeholder="{{__('Name in Arabic')}}">
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name_en" class="form-control" id="inputNameEN"
                                   value="{{$country->name_en}}" placeholder="{{__('Name in English')}}">
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="currency_id" class="form-control js-example-basic-single">
                            @foreach(\App\Models\Currency::all() as $currency)
                                <option
                                    value="{{$currency->id}}" {{$country->currency_id == $currency->id ? 'selected' : ''}}>{{$currency->name}}</option>
                            @endforeach
                        </select>
