        ...
        <div class="card-content js__card_content">
            <form id="filtration-form">
                                ...
                                <ul class="list-inline">
                                    <li>
                                        <div class="radio info">
                                            <input type="radio" name="type" value="delay"  id="radio-10"><label for="radio-10">{{__('Delay')}}</label></div>
                                    </li>
                                    <li>
                                        <div class="radio pink">
                                            <input type="radio" name="type" value="extra" id="radio-12"><label for="radio-12">{{__('Extra')}}</label></div>
                                    </li>
                                </ul>
                            </li>
                ...
                <button type="submit"
                        ...
                        <a href="{{route('admin:employees_delay.index')}}"
