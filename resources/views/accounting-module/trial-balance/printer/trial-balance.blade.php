                    ...
                    foreach($data as $row) {
                        ...
                        foreach($table_header as $col) {
                            ...
                            if ($col == 'transactions_debit') {
                                echo '<td>'. abs($row->debit_balance) .'</td>';
                            } else if ($col == 'transactions_credit') {
                                echo '<td>'. abs($row->credit_balance) .'</td>';
                            } else {
                                if ($row->$col == 'debit') 
                                    echo '<td>'. __('accounting-module.debit') .'</td>';
                                else if ($row->$col == 'credit') 
                                    echo '<td>'. __('accounting-module.credit') .'</td>';
                                else
                                    echo '<td>'. $row->$col .'</td>';
                            }
                        }
