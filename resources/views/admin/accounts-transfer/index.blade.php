...
@section('title')
    <title>{{ __('Super Car') }} - {{__('Accounts Transfer')}} </title>
@endsection
    ...
    <div class="row small-spacing">
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item">  {{__('Accounts Transfer')}}</li>
            </ol>
        </nav>
        ...
        <div class="col-xs-12">
            ...
            <div class="box-content card bordered-all js__card top-search">
                ...
                <div class="card-content js__card_content">
                    <form action="{{route('admin:accounts-transfer.index')}}" method="get" id="filtration-form">
        ...
        <div class="col-xs-12">
            <div class="box-content card bordered-all js__card">
                ...
                <i class="fa fa-money"></i>   {{__('Accounts Transfer')}}
                 </h4>
                ...
                <div class="card-content js__card_content" style="">
                    {{-- <ul class="list-inline pull-left top-margin-wg">
                       ...
                       'route' => 'admin:accounts-transfer.create',
                           'new' => '',
                          ])
                        </li>
                            ...
                            <li class="list-inline-item">
                             ...
                             'route' => 'admin:accounts.transfer.deleteSelected',
                              ])
                                @endcomponent
                            </li>
                    ...
                    <div class="table-responsive">
                        @php
                            $view_path = 'admin.accounts-transfer.options-datatable';
                        @endphp
                        ...
                        <table id="currencies" class="table table-bordered" style="width:100%;margin-top:15px">
                            ...
                            <tr>
                                ...
                                <th class="text-center column-account-from" scope="col">{!! __('Account From') !!}</th>
                                <th class="text-center column-account-to" scope="col">{!! __('Account To') !!}</th>
                            ...
                            <tbody>
                            @foreach($accountsTransfer as $index=>$transfer)
                                <tr>
                                    <td class="text-center column-id">{!! $index +1 !!}</td>
                                    <td class="text-center column-account-from">{!! optional($transfer->accountFrom)->name !!}</td>
                                    <td class="text-center column-account-to">{!! optional($transfer->accountTo)->name !!}</td>
                                    <!-- <td>{!! $transfer->date !!}</td> -->
                                    ...
                                    <td>
                                        ...
                                        {{-- @component('admin.buttons._edit_button',[
                                                    'id' => $transfer->id,
                                                    'route'=>'admin:accounts-transfer.edit'
                                                     ])
                                        @endcomponent

                                        @component('admin.buttons._delete_button',[
                                                    'id'=>$transfer->id,
                                                    'route' => 'admin:accounts-transfer.destroy',
...
@section('js')
    <script type="application/javascript">
        function getByBranch() {
            ...
            $.ajax({
                url: '{{route('admin:get.accounts.transfer.by.branch')}}',
                type: "get",
                data: {id: id},
