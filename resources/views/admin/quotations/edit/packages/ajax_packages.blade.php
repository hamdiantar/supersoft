...
<div class="col-xs-12" id="ajax_parts_box">
                            ...
                            <div>
                                @foreach($packages as $package)
                                    <li style="font-size: 12px; padding: 10px; margin: 5px;"
                                        ...
                                        <a class="nav-link active" onclick="getPackageDetails('{{$package->id}}')"
            ...
            <div class="table-responsive class-scroll-wg">
                <table id="invoiceItemsDetails" class="table table-bordered" style="width:100%">
                    ...
                    @foreach($packageType->items as $index=>$package_item)
                        ...
                        @include('admin.quotations.edit.packages.package_details')

                        <input type="hidden" name="package_id" value="{{$package->id}}" id="package-{{$index+1}}">
                    @endforeach
                    </tbody>
                ...
                <input type="hidden" name="packages_items_count" id="packages_items_count"
                       value="{{$packageType->items->count()}}">
            </div>
        </div>
    </div>
</div>
