<tr data-id="{{$package->id}}" id="remove_package_{{$package->id}}" class="package_tr_{{$package->id}}">
    ...
    <td>
        <input  type="number" class="form-control" value="0" name="packages_qty[]"
    ...
    <td>
        <input  type="number" class="form-control" value="{{$package->total_after_discount}}"
...
{{--        </select>--}}
    ...
    <td>
        <input  type="number" class="form-control" value="0" name="packages_discounts[]"
               onkeyup="calculatePackageValues({{$package->id}})"
               onchange="calculatePackageValues({{$package->id}})"
    ...
    <td>
        <i class="fa fa-trash fa-2x" onclick="removePackageFromTable({{$package->id}})" style="color:#F44336; cursor: pointer"></i>

        <a  data-toggle="modal" onclick="getPackageInfo({{$package->id}})"
