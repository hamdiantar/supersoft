                ...
                <ul class="list-inline margin-bottom-0">
                    <div class="row">
                        ...
                        <li class="form-group col-lg-4">
                            ...
                            <li class="form-group col-lg-4">
                                <label> {{__('deportation method')}} </label>
                                <ul class="list-inline">
                                    <li>
                                        <div class="radio info">
                                            <input type="radio" name="deportation" value="bank"  id="radio-10"><label for="radio-10">{{__('Account')}}</label></div>
                                    </li>
                                    <li>
                                        <div class="radio pink">
                                            <input type="radio" name="deportation" value="safe" id="radio-12"><label for="radio-12">{{__('Locker')}}</label></div>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="form-group col-lg-4">
                                ...
                                <ul class="list-inline">
                                    <li>
                                        <div class="radio info">
                                            <input type="radio" name="operation" value="deposit"  id="radio-23"><label for="radio-23">{{__('deposit')}}</label></div>
                                    </li>
                                    <li>
                                        <div class="radio pink">
                                            <input type="radio" name="operation" value="withdrawal" id="radio-233"><label for="radio-233">{{__('withdrawal')}}</label></div>
                                    </li>
                                </ul>
                            </li>
