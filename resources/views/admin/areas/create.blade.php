        ...
        <div class="row small-spacing">
            <nav>
                ...
                <li class="breadcrumb-item"><a href="{{route('admin:home')}}"> {{__('Dashboard')}}</a></li>
                    <li class="breadcrumb-item"><a href="{{route('admin:cities.index')}}"> {{__('areas')}}</a></li>
                    <li class="breadcrumb-item active"> {{__('Create Area')}}</li>
                </ol>
            </nav>
            <div class="col-xs-12">
            <div class=" card box-content-wg-new bordered-all primary">
                ...
                <div class="box-content">
                    <form  method="post" action="{{route('admin:areas.store')}}" class="form">
                        @csrf
                        @method('post')
                        <div class="row">
