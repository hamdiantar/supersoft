    ...
    <div class="card-content js__card_content" style="">
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" placeholder="{{__('Search')}}" id="searchInSparePartsType" class="form-control" onkeyup="searchInPartsType(event)">
                <ul class="nav nav-pills nav-stacked anyClass form-control" style="text-align: center">
                    <div class="searchResultSparePartsType">
                        <li class="nav-item">
                            <a class="nav-link active" href="#" onclick="getSparePartsById('all')" id="spare_part_type">
                                <div class="card">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="searchInParts" onkeyup="serchINParts(event)" placeholder="{{__('Search')}}" class="form-control">
