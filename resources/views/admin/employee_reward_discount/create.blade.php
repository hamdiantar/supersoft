...
@section('title')
    <title>{{ __('Super Car') }} - {{ __('Create Employees Rewards / Discounts') }} </title>
@endsection
...
@section('content')
    ...
    <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Create Employees Rewards / Discounts')}}</li>
            </ol>
        </nav>
        <div class="col-xs-12">
        <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial"><i class="fa fa-user"></i>  {{__('Create Employees Rewards / Discounts')}}
                ...
                <button class="control text-white" style="background:none;border:none;font-size:12px">{{__('Save')}}<img class="img-fluid" style="width:50px;height:50px;margin-top:-20px;margin-bottom:-13px" src="{{asset('assets/images/f1.png')}}"></button>
                    ...
                    <form method="post" action="{{route('admin:employee_reward_discount.store')}}" class="form">
                        @csrf
                        @method('post')
                        <div class="row">
                                        ...
                                        <ul class="list-inline">
                                            <li>
                                                <div class="radio info">
                                                    <input type="radio" name="type" value="reward" checked
                                                           id="radio-10"><label
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control time" name="cost" value="0">
                                </div>
                            </div>
                        </div>
