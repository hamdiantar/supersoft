...
@section('title')
    <title>{{ __('Super Car') }} - {{ __('Create Employee additional / Delay') }} </title>
@endsection
...
@section('content')
    ...
    <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Create Employee additional / Delay')}}</li>
            </ol>
        </nav>
        <div class="col-xs-12">
        <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial"><i class="fa fa-user"></i>  {{__('Create Employee additional / Delay')}}
                ...
                <button class="control text-white" style="background:none;border:none;font-size:12px">{{__('Save')}}<img class="img-fluid" style="width:50px;height:50px;margin-top:-20px;margin-bottom:-13px" src="{{asset('assets/images/f1.png')}}"></button>
                    ...
                    <form method="post" action="{{route('admin:employees_delay.store')}}" class="form">
                        @csrf
                        @method('post')
                                        ...
                                        <ul class="list-inline">
                                            <li>
                                                <div class="radio info">
                                                    <input type="radio" name="type" value="delay" checked
                                                           id="radio-10"><label
...
<span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                                            ...
                                            <input type="text" class="form-control time" name="number_of_hours" value="0">
</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
<span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                                            <input type="text" class="form-control time" name="number_of_minutes" value="0">
                                        </div>
                                        </div>
                                    </div>
