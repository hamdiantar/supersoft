...
<div class="row small-spacing">
        ...
        <div class="box-content card bordered-all js__card">
            <h4 class="box-title with-control">
                <i class="fa fa-plus"></i>{{__('add new Examination')}}
            </h4>
            <!-- /.box-title -->
                            ...
                            <tr>
                                ...
                                <div class="btn-group margin-top-10">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <button class="btn btn-info editExaminationsBtn" 
                                            examination-id="{{ $assetExamination->id }}"
                                            examination-name="{{ $assetExamination->examination_details }}"
                                            examination-startDate="{{ $assetExamination->start_date }}"
                                            examination-endDate="{{ $assetExamination->end_date }}"
...
@section('js')
{!! JsValidator::formRequest('App\Http\Requests\Admin\Asset\AssetExaminationRequest'); !!}
    <script type="application/javascript">
        $(document).ready(function () {
            invoke_datatable($('#datatable-with-btns'))
            $(".select2").select2();

            $(".editExaminationsBtn").on('click' , function(){
                $("#name").val($(this).attr('examination-name'));
                $("#start_date").val($(this).attr('examination-startDate'));
                $("#end_date").val($(this).attr('examination-endDate'));
                $("#asset_examination_id").val($(this).attr('examination-id'));
