...
class RevenueReceipts {
    ...
    function __construct($query_builder ,$visible_columns) {
        ...
        $this->columns = [
            'id' ,'receiver', 'revenue_item_id', 'cost', 'deportation_method', 'deportation', 'payment_type', 'created_at', 'updated_at'
        ];
        $this->header = [
            'id' => __('Revenue No'),
    ...
    private function print() {
        ...
        return view('server-side-print' ,[
            ...
            'header' => $this->header,
            'title' => __('Revenue Receipts Printing'),
                    ...
                    foreach ($columns_keys as $key) {
                        switch ($key) {
                            case 'id':
                                $value = '##_'.$record->id;
                                break;
                            case 'revenue_item_id':
                                $value = optional($record->revenueItem)->item;
                                break;
                            case 'deportation':
    ...
    private function excel() {
        ...
        return Excel::download($export_object, 'Revenue-Receipts-'.date('YmdHis').'.csv');
    }
}