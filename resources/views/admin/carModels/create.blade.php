...
@section('title')
<title>{{ __('Super Car') }} - {{ __('Create Car Model') }} </title>
@endsection
@section('content')
        <div class="row small-spacing">
            <nav>
                ...
                <li class="breadcrumb-item"><a href="{{route('admin:home')}}"> {{__('Dashboard')}}</a></li>
                    ...
                    <li class="breadcrumb-item active"> {{__('Create Car Model')}}</li>
                </ol>
            </nav>
            <div class="col-xs-12">
            <div class=" card box-content-wg-new bordered-all primary">
                ...
                <div class="box-content">
                    <form  method="post" action="{{route('admin:carModels.store')}}" class="form">
                        @csrf
                        @method('post')
                        <div class="row">
