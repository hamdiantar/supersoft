...
<div style="text-align: right ">
    <h5>{{optional($branch)->name_ar}}</h5>
    <h5 >{{optional($branch)->phone1}} </h5>
    <h5 >{{optional($branch)->address}} </h5>
    <h5 >{{optional($branch)->fax}}</h5>
    <h5 >{{optional($branch)->tax_card}}</h5>
</div>
</div>
                        <div class="col-xs-4">
