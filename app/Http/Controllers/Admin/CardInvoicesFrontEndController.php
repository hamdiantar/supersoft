...
class CardInvoicesFrontEndController extends Controller
{
    public function getPartsByType(Request $request)
    {
        ...
        if ($parts->count() > 0) {
            ...
            $htmlParts = view('admin.work_cards.invoices.parts.parts_in_card',
                compact('maintenance_id', 'parts'))->render();
    ...
    public function partDetails(Request $request){
        ...
        return view('admin.work_cards.invoices.parts.part_details',
            compact('part','items_count','maintenance_id','maintenance_type_id'));
    }
    ...
    public function purchaseInvoiceData(Request $request){
        ...
        return view('admin.work_cards.invoices.parts.purchase_invoice_data',
            compact('invoice_item','part','invoice','maintenance_id','maintenance_type_id', 'index'));
    }
    ...
    public function getServicesByType(Request $request){
        ...
        return view('admin.work_cards.invoices.services.ajax_services_by_type',
            compact('services','maintenance_id'));
    }
    ...
    public function getServicesDetails(Request $request){
        ...
        return view('admin.work_cards.invoices.services.service_details',
            compact('service','items_count','maintenance_id','maintenance_type_id','employees'));
    }
    ...
    public function packageDetails(Request $request){
        ...
        return view('admin.work_cards.invoices.packages.package_details',
            compact('package','items_count','maintenance_id','maintenance_type_id'
            ,'employees'));
