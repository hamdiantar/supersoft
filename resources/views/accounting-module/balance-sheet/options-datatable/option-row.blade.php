...
<div class="col-md-8 col-sm-8 col-xs-12 wg-style buttons-wg text-right-wg" style="padding-left: 0;margin-top:10px">

<button class="dt-button buttons-collection buttons-colvis" onclick="invoke('print' ,event)"
        {{ user_can_access_accounting_module(NULL ,'balance-sheet' ,'print') ? '' : 'disabled' }}>
...
عرض
    ...
    <select onchange="change_rows(event)" class="wg-select">
        <option {{ isset($_GET['rows']) && $_GET['rows'] == 10 ? 'selected' : '' }} value="10">
            10
        </option>
...
<div class="col-md-4 col-sm-4 col-xs-12 text-left-wg" style="padding-right: 0;margin-top:10px">
    ...
    <span class="input-group-btn">
            <button class="btn btn-default" type="button" onclick="free_search('#free-search' ,'key')">
                <i class="fa fa-search"></i>
            </button>
        </span>
     <input id="free-search" type="text" class="search-btn-wg"
            placeholder="{{ __('accounting-module.search') }}"
