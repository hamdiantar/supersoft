...
@section('title')
    <title>{{ __('Create Settlement') }} </title>
@endsection
    ...
    <div class="row small-spacing">
        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Create Settlement')}}</li>
            </ol>
        </nav>
...
@section('js-validation')
    ...
    <script type="application/javascript">
        ...
        function changeBranch () {
            ...
            window.location.href = "{{route('admin:settlements.create')}}" + "?branch_id=" + branch_id ;
        }
