...
class Attendance {
    ...
    function __construct($query_builder ,$visible_columns) {
        ...
        $this->columns = [
            'name' ,'status', 'date', 'time', 'created_at', 'updated_at'
        ];
        $this->header = [
    ...
    private function print() {
        ...
        return view('server-side-print' ,[
            ...
            'header' => $this->header,
            'title' => __('Employees Attendance Printing'),
                    ...
                    foreach ($columns_keys as $key) {
                        switch ($key) {
                            case 'name':
                                ...
                                break;
                            case 'status':
                                $value = $record->type === __('Attendance') ? __('Attendance') : __('Departure');
                                break;
                            default:
                                $value = $record[$key];
                                break;
    ...
    private function excel() {
        ...
        return Excel::download($export_object, 'Employees-Attendance-'.date('YmdHis').'.csv');
    }
}