...
@section('title')
    <title> {{ __('Edit Concession Type') }} </title>
@endsection
    ...
    <div class="row small-spacing">
        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Edit Concession Type')}}</li>
            </ol>
        </nav>
        ...
        <div class="col-xs-12">
            ...
            <div class=" card box-content-wg-new bordered-all primary">
                ...
                <div class="box-content">
                    <form method="post" action="{{route('admin:concession-types.update',$concessionType->id)}}" class="form" enctype="multipart/form-data">
                        @method('PATCH')
                        @csrf
...
@section('js-validation')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\ConcessionTypes\UpdateRequest', '.form'); !!}
