...
عرض
        ...
        <select onchange="change_rows(event)" class="wg-select">
            ...
            <option {{ isset($_GET['rows']) && $_GET['rows'] == 250 ? 'selected' : '' }} value="250">
                250
            </option>

            <option {{ isset($_GET['rows']) && $_GET['rows'] == 500 ? 'selected' : '' }} value="500">
                500
            </option>
        </select>
        قيم كل صفحه
...
<div class="col-md-4 col-sm-4 col-xs-12 text-left-wg" style="padding-right: 0;margin-top:10px">
    ...
    <span class="input-group-btn">
        ...
        placeholder="{{ __('accounting-module.search') }} : {{ __('Name') }}"
