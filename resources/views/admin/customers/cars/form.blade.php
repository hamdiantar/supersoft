<div class="col-xs-12">
    <div class="box-content card bordered-all blue-1 box-content-wg js__card">
        ...
        <div class="card-content js__card_content" style="">
            <form class="form" action="{{route('admin:cars.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon fa fa-globe"></span>
                            <select name="company_id" class="form-control  js-example-basic-single company_id_create" id="company_id" onchange="carModels('create')">
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon fa fa-globe"></span>
                            <select name="model_id" class="form-control  js-example-basic-single model_id_create" id="model_id">
                                <option value="" class="removeToNewData_create">{{__('Select Car Model')}}</option>
                ...
                <div class="form-group  col-md-3 col-sm-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-car"></i></span>
                        <input type="text" name="speedometer" class="form-control" id="speedometer"
                ...
                <div class="form-group  col-md-3 col-sm-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-code"></i></span>
                        <input type="text" name="motor_number" class="form-control" id="motor_number"
                ...
                <div class="form-group  col-md-6 col-sm-6">
                    ...
                    <div class="image-container small-wg handing wg-i ani image-format-hd wg-edit-img"
                        ...
                        <a href="{{asset('images/default.png')}}" data-lightbox="roadtrip">
                            ...
                            <div class="image-container small-wg ani image-format-hd" style="width: 100%;">
                                <a id="openLargeImage" href="{{asset('images/default.png')}}" data-lightbox="roadtrip">
                ...
                <div class="form-group col-sm-12" id="addButtonForUpdate">
                    ...
                    <button type="submit" id="addCar" name="button_1"
                            class="btn btn-primary   waves-effect waves-light updateCar">
                        <i class="ico ico-left fa fa-save"></i>
                        {{__('Save')}}</button>

                    {{--                    <button type="submit" id="addCarAndBack" name="button_1"--}}
