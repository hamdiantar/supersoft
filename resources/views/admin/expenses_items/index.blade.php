        ...
        @include('admin.expenses_items.parts.search')
                ...
                <i class="fa fa-money"></i> {{__('Expenses Items')}}
                 ...
                 <div class="card-content js__card_content" style="">
                  ...
                  'route' => 'admin:expenses_items.create',
                      'new' => '',
                     ])
                       </li>
                            ...
                            <li class="list-inline-item">
                                ...
                                'route' => 'admin:expenses_items.deleteSelected',
                                 ])
                                @endcomponent
                            </li>
                ...
                <table id="revenuesItems" class="table table-bordered" style="width:100%">
                    ...
                    @foreach($expenseItems as $index=>$item)
                        <tr>
                            ...
                            {!! optional($item->expenseType)->type !!}
                            </span>
                            </td>
                            ...
                            <td>
                                ...
                                @component('admin.buttons._edit_button',[
                                            'id'=>$item->id,
                                            'route' => 'admin:expenses_items.edit',
                                             ])
                                @endcomponent

                                @component('admin.buttons._delete_button',[
                                            'id'=> $item->id,
                                            'route' => 'admin:expenses_items.destroy',
                                             ])
                                @endcomponent
                                @endif
                            </td>
