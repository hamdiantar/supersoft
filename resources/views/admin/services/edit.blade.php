...
@section('title')
<title>{{ __('Super Car') }} - {{__('Edit service')}}</title>
@endsection
...
@section('content')
    ...
    <nav>
        ...
        <div class=" card box-content-wg-new bordered-all primary">
                    <h1 class="box-title bg-info" style="text-align: initial"><i class="fa fa-gear"></i>{{__('Edit service')}}
                ...
                <div class="box-content">
                    <form method="post" action="{{route('admin:services.update',$service->id)}}" class="form"
...
@section('js-validation')
        {!! JsValidator::formRequest('App\Http\Requests\Admin\Services\UpdateServiceRequest', '.form'); !!}
