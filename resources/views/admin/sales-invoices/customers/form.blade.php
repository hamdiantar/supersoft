                ...
                <form id="add_customer_form">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                {{--                                        <select name="branch_id" class="form-control js-example-basic-single" style="width: 100%"--}}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback" id="appendCompanyData">
                                        <label for="inputSymbolAR" class="control-label">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group company_data col-sm-3" id="CompanyResponsible"
                                     style="display: {{isset($supplier) && $supplier->type == 'company'? '':'none' }};">
                                    <label for="responsible" class="control-label">Responsible Name</label>
                                    <div class="input-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedbac">
                                        ...
                                        <select name="customer_category_id" class="form-control js-example-basic-single"
                                                style="width: 100%" id="customerCategory">
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <button id="btnsave" type="button" onclick="addCustomer()" class="btn hvr-rectangle-in saveAdd-wg-btn hvr-shrink">
                                <i class="ico ico-left fa fa-save"></i>
                                {{__('Save')}}
                            </button>

                            <button id="reset" type="button" class="btn hvr-rectangle-in resetAdd-wg-btn hvr-shrink">
                                <i class="ico ico-left fa fa-trash"></i>
                                {{__('Reset')}}
                            </button>

                            <button data-dismiss="modal" type="button"
                                    class="btn hvr-rectangle-in closeAdd-wg-btn hvr-shrink">
