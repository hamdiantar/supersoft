<div style="border: #AAA solid 1px;border-top:20px solid grey;border-radius:15px 15px 5px 5px;min-height:170px">
    @if($locker_transfer->branch)
        @php
            $branch = $locker_transfer->branch;
            $img = $branch->img;
    ...
    <div class="num-w">
        <div style="border: #AAA solid 1px;border-radius:5px;padding:10px;margin-top:10px">
            <h3 class="text-center" style="font-weight:bold ">{{ __('words.locker-transfer') }}</h3>
                ...
                <div class="col-xs-6">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <td>{{ optional($locker_transfer->locker_transfer_pivot->locker_exchange_permission)->permission_number }}</td>
                        </tbody>
                    </table>
                </div>
                <div class="col-xs-6">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <td>{{ optional($locker_transfer->locker_transfer_pivot->locker_receive_permission)->permission_number }}</td>
                        </tbody>
                    </table>
                </div>
                <div class="col-xs-6">
                    <table class="table table-bordered">
                        <tbody>
                            <th width="40%" style="background-color:#EEE !important;color:black !important">{{__('Locker From')}}</th>
                            <td>{{ optional($locker_transfer->locker_transfer_pivot->locker_exchange_permission->fromLocker)->name }}</td>
                        </tbody>
                    </table>
                </div>
                <div class="col-xs-6">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <td>{{ optional($locker_transfer->locker_transfer_pivot->locker_exchange_permission->toLocker)->name }}</td>
                        </tbody>
                    </table>
                </div>
                <div class="col-xs-6">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <td>{{ optional($locker_transfer->locker_transfer_pivot->locker_exchange_permission->employee)->name }}</td>
                        </tbody>
                    </table>
                </div>
                <div class="col-xs-6">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <td>{{ optional($locker_transfer->locker_transfer_pivot->locker_receive_permission->employee)->name }}</td>
                        </tbody>
                    </table>
                </div>
                <div class="col-xs-6">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <td>{{ optional($locker_transfer->locker_transfer_pivot->locker_exchange_permission)->operation_date }}</td>
                        </tbody>
                    </table>
                </div>
                <div class="col-xs-6">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <td>{{ optional($locker_transfer->locker_transfer_pivot->locker_receive_permission)->operation_date }}</td>
                        </tbody>
                    </table>
                </div>
                <div class="col-xs-6">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <td>{{ optional($locker_transfer->locker_transfer_pivot->locker_exchange_permission->cost_center)->name }}</td>
                        </tbody>
                    </table>
                </div>
                <div class="col-xs-6">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <td>{{ optional($locker_transfer->locker_transfer_pivot->locker_receive_permission->cost_center)->name }}</td>
                        </tbody>
                    </table>
                </div>
                <div class="clearfix"></div>
                <div class="col-xs-6">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <td>{{ optional($locker_transfer->locker_transfer_pivot->locker_exchange_permission)->amount }}</td>
                        </tbody>
                    </table>
                </div>
            </div>
