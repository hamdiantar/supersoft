                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        value="{{$winchType && $winchType->cardInvoiceWinchRequest ? $winchType->cardInvoiceWinchRequest->request_long:''}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="request_lat" required id="lat" class=" form-control" readonly
                                               value="{{$winchType && $winchType->cardInvoiceWinchRequest ? $winchType->cardInvoiceWinchRequest->request_lat:''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
...
{{--                                            <th scope="col">{!! __('Action') !!}</th>--}}
                                        ...
                                        <tr>
                                          @include('admin.work_cards.invoices.winch.winch_row')
                                        </tr>
