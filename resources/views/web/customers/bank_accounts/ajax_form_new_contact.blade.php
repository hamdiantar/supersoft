    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" name="bankAccount[{{$index}}][bank_name]" required class="form-control">
            </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <span class="asterisk" style="color: #ff1d47"> * </span>
                <input type="text" name="bankAccount[{{$index}}][account_name]" required class="form-control">
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <span class="asterisk" style="color: #ff1d47"> * </span>
                <input type="text" name="bankAccount[{{$index}}][branch]" required class="form-control">
            </div>
        </div>
    </div>
   ...
   <div class="row">
       <div class="col-md-3">
           <div class="form-group">
               ...
               <span class="asterisk" style="color: #ff1d47"> * </span>
               <input type="text" name="bankAccount[{{$index}}][account_number]" class="form-control" style=" height: 45px;">
           </div>
       ...
       <div class="col-md-3">
           <div class="form-group">
               ...
               <span class="asterisk" style="color: #ff1d47"> * </span>
               <input type="text" name="bankAccount[{{$index}}][iban]" required class="form-control">
           </div>
       </div>
       ...
       <div class="col-md-3">
           <div class="form-group">
               ...
               <span class="asterisk" style="color: #ff1d47"> * </span>
               <input type="text" name="bankAccount[{{$index}}][swift_code]" required class="form-control">
           </div>
       </div>
